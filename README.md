...
- [Education finance MLOps](https://github.com/LucasRangelSSouza/education-finance-mlops): municipality-year anomaly-triage reference with lineage and drift controls.
- [PNCP opportunity recommender](https://github.com/LucasRangelSSouza/pncp-opportunity-recommender): transparent procurement-opportunity ranking with organization-only profiles and offline evaluation.
...
Use my [GitHub profile](https://github.com/LucasRangelSSouza) for public contact and project discussion.
